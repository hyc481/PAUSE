...
from bench.utils.parse_tool_call import parse_tool_call, validate_tool_call
...
_DEFAULT_SCHEMA_DIR = TOOL_SCHEMAS_DIR
_DEFAULT_PLATFORM_TOOLS_SCHEMA = str(_DEFAULT_SCHEMA_DIR / "platform_tools.json")
_DEFAULT_USER_TOOLS_SCHEMA = str(_DEFAULT_SCHEMA_DIR / "user_tools.json")
...
class AgentRunner:
    def __init__(
        self,
        platform_tools_schema_path: str = _DEFAULT_PLATFORM_TOOLS_SCHEMA,
        user_tools_schema_path: str = _DEFAULT_USER_TOOLS_SCHEMA,
    ):
