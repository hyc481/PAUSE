...
# 相对根目录导入
from bench.backend.configuration.configuration import (
    load_initialization_profile,
)
from bench.backend.build_user.inject_sports import inject_sports
from bench.backend.build_user.source_assignment import generate_source_assignment
from bench.backend.build_user.system_settings import generate_system_settings
from bench.backend.build_user.inject_meals import generate_meals
from bench.backend.build_user.generate_profile import generate_profile

# ============================================================
# 路径
# ============================================================

BACKEND_DIR = Path(__file__).resolve().parents[1]   # bench/backend
